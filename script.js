const nomeTimeA = prompt('Digite o nome do primeiro time:'); 
const nomeTimeB = prompt('Digite o nome do segundo time:');

const nomeA_HTML = document.getElementById('nomeTimeA'); // manipular DOM
...
nomeA_HTML.innerText = nomeTimeA; //Altera texto do ID no HTML
...
//detecta evento de clique e executa uma função
...
function verificarFimDoSet() {
    if (pontoA >= 21  && pontoA - pontoB >= 2) {
        alert(`${nomeTimeA} venceu o SET!`); //criar alert pelo html
